-- Google Ads OAuth connections + allow provider=google on campaign drafts
...
CREATE POLICY "Service role manages google ads connections"
...
-- Expand draft provider check to include google
