...
import { PolitykaPrywatnosciMarketingNowContent } from "@/content/PolitykaPrywatnosciMarketingNowContent";

export const Route = createFileRoute("/polityka-prywatnosci")({
  head: () => ({
    meta: [
      { title: "Polityka prywatności i cookies — MarketingNow" },
      {
        name: "description",
        content:
          "Polityka prywatności i plików cookies serwisu MarketingNow (marketingnow.site) — RODO, integracje, AI, cookies.",
      },
      { property: "og:title", content: "Polityka prywatności — MarketingNow" },
      {
        property: "og:description",
        content: "Jak przetwarzamy Twoje dane osobowe w MarketingNow — RODO, AI, cookies.",
      },
    ],
  }),
  ...
  return (
    <div className="collins-root min-h-screen bg-background text-foreground flex flex-col">
      ...
      <article className="mx-auto max-w-3xl px-6 py-16 flex-1 w-full prose prose-sm md:prose-base prose-headings:tracking-tight prose-headings:font-semibold prose-h1:text-4xl prose-h2:mt-12 prose-h2:text-2xl prose-h3:text-lg prose-p:leading-relaxed prose-strong:text-foreground prose-li:leading-relaxed">
        <PolitykaPrywatnosciMarketingNowContent />
