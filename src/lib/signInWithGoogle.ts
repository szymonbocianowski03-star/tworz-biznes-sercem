...
export const GOOGLE_AUTH_NOT_CONFIGURED =
  "google_not_configured: Dodaj do .env adres podglądu Lovable: VITE_LOVABLE_APP_URL=https://twoj-projekt.lovable.app (bez sekretów — logowanie pójdzie przez broker Lovable). Albo skopiuj GOOGLE_OAUTH_* z Lovable.";
