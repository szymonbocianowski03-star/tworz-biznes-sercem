          ...
          <div className="mt-6">
            {comingSoon ? (
              <p className="text-sm text-muted-foreground">
                Integracja TikTok Ads będzie dostępna <span className="font-semibold text-foreground">wkrótce</span> — pozwoli
              ...
              <>
                ...
                <p className="mt-3 text-xs text-muted-foreground">
                  Zalogujesz się na swoje konto TikTok for Business i wybierzesz konto reklamowe.
                </p>
              </>
            )}
          </div>
